...
from background import (
    ...
    credit_batches_loop, coins_refund_loop, db_cleanup_loop, fk_auto_check_loop, gpt_code_rechecker_loop, gpt_codes_cleanup_loop, gpt_orphans_loop, gpt_pool_audit_loop, models_desc_refresh_loop, nsgifts_balance_alert_loop, perplexity_codes_cleanup_loop,
...
_ADMIN_CMDS = (
    ...
    "/gpt_codes_to_bpa", "/add_gpt_codes", "/giveaway_where", "/gpt_lost",
)
